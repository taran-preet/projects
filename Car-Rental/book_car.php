	...
	<section class="listings">
		<div class="wrapper">
			...
			?>
				...
				<h3><u> Fill the Details to Hire <?php echo $rws['car_name'];?>. </h3></u>
				<?php
				...
				<form method="post">
					<table>
						<tr>
							<td>Full Name:</td>
							<td><input type="text" name="fname" class="a" placeholder="Enter Name" required></td>
						</tr>
						<tr>
							<td>Phone Number:</td>
							<td><input type="text" name="phone" required class="a" placeholder="Enter Phone no."></td>
						</tr>
						<tr>
							<td>Email Address:</td>
							<td><input type="email" name="email" required class="a" placeholder="Enter Email"></td>
						</tr>
						<tr>
							<td>ID Number:</td>
							<td><input type="text" name="id_no" required class="a" placeholder="Enter ID"></td>
						</tr>
						<tr>
							<td>Gender:</td>
							<td>
						...
						<tr>
							<td>Location:</td>
							<td><input type="text" name="location" required class="a" placeholder="Enter Location"></td>
						</tr>
						<tr>
						...
						if(isset($_POST['save'])){
							...
							if($result == TRUE){
								echo "<script type = \"text/javascript\">
											alert(\"Successfully Registered. we will shortly contact you\");
